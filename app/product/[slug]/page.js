        ...
        <>
            ...
            {(product != "undefined") ? (<div className="flex flex-col md:flex-row pt-[11vh] w-[100vw] min-h-[100vh] md:px-[10vw] px-[2vw] z-50">
                <div className="flex justify-end md:w-[30vw] left-0 ">
                    <img className="md:h-[78vh] md:rounded-s-[5vw] md:rounded-b-[5vw]" src={`${product.image}`} alt={`${product.title}`} />
                </div>
                <div className="relative md:w-[50vw] flex flex-col gap-4 py-2 items-start md:bg-white rounded-e-[5vw]">
                    <h1 className="font-bold text-[5vh] py-2 text-center rounded-e-[5vw] md:text-black">{product.title}</h1>
                ...
                {(!hide) && (
                    <div className="fixed p-5 bg-white shadow-lg shadow-violet-600 md:w-[50vw] text-black rounded-[5vw] md:h-[70vh] right-[25vw] top-[25vh]">
