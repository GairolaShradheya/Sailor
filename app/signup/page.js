        ...
        <div className='flex flex-col md:flex-row gap-2'>
          <div className='flex flex-col gap-6 items-end'>
            <div className='flex flex-col md:flex-row gap-5 justify-center items-center'>
              ...
              <input onChange={(e) => { handlechange(e) }} className='z-50 md:w-[20vw] h-[5vh] rounded-full px-10 py-5 text-black' type="text" name="name" placeholder='Enter your name' />
            </div>
            <div className='flex flex-col md:flex-row gap-5 justify-center items-center'>
              <h2 className='md:pl-5 text-2xl font-bold'>Your Mobile No. :-</h2>
              <input onChange={(e) => { handlechange(e) }} className='z-50 md:w-[20vw] h-[5vh] rounded-full px-10 py-5 text-black' type="number" name="number" placeholder='Enter your mobile no.' />
            </div>
            <div className='flex flex-col md:flex-row gap-5 justify-center items-center'>
              <h2 className='md:pl-5 text-2xl font-bold'>Your email :-</h2>
              <input onChange={(e) => { handlechange(e) }} className='z-50 md:w-[20vw] h-[5vh] rounded-full px-10 py-5 text-black' type="email" name="email" placeholder='Enter your email' />
            </div>
          </div>
          <div className='flex flex-col gap-6 items-start'>
            <div className='flex flex-col md:flex-row gap-5 justify-center items-center'>
              <h2 className='md:pl-5 text-2xl font-bold'>Your Sername :-</h2>
              <input onChange={(e) => { handlechange(e) }} className='z-50 md:w-[20vw] h-[5vh] rounded-full px-10 py-5 text-black' type="text" name="sername" placeholder='Enter your sername' />
            </div>
            <div className='flex flex-col md:flex-row gap-5 justify-center items-center'>
              <h2 className='md:pl-5 text-2xl font-bold'>Your Address :- </h2>
              <input onChange={(e) => { handlechange(e) }} className='z-50 md:w-[20vw] h-[5vh] rounded-full px-10 py-5 text-black' type="text" name="address" placeholder='Enter your address' />
            </div>
            <div className='flex flex-col md:flex-row gap-5 justify-center items-center'>
              <h2 className='md:pl-5 text-2xl font-bold'>Your Password :-</h2>
              <input onChange={(e) => { handlechange(e) }} className='z-50 md:w-[20vw] h-[5vh] rounded-full px-10 py-5 text-black' type="password" name="password" placeholder='Enter your password' />
            </div>
          </div>
