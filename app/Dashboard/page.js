...
function Dashboard() {
    ...
    return (
        <div className='ALL flex flex-col gap-5 min-h-[100vh] text-white items-center pt-[10vh] '>
            ...
            {user && (
                <div className='flex gap-5 '>
                    <div className='First flex flex-col h-[68vh] w-[40vw] border border-gray-500 rounded-3xl p-5 items-center gap-5 overflow-x-auto'>
                        <div className='flex justify-center gap-5 '>
                            <div className='relative'>
                                <img src={`${user.image}`} alt="profile" className='text-center bg-black h-32 w-32 rounded-full' />
                        ...
                        {(hide) ? (<button className='font-bold w-fit text-xl border border-white shadow-violet-400 shadow-lg px-3 py-1 rounded-lg bg-slate-900' onClick={() => { HandleEditClick() }}>Edit profile</button>) :
                            (<div className='FormClass flex flex-col items-start p-5 w-full gap-2'>
                                <div className='flex w-full items-center justify-between'>
                                    <h2 className='pl-5 text-2xl font-bold '>Your Name :-</h2>
                                    <input onChange={(e) => { handlechange(e) }} className='w-[50%] h-[5vh] rounded-full px-10 py-5 text-black' value={user.name} type="text" name="name" placeholder='Enter your name' />
                                </div>
                                <div className='flex w-full items-center justify-between'>
                                    <h2 className='pl-5 text-2xl font-bold '>Mobile No. :-</h2>
                                    <input onChange={(e) => { handlechange(e) }} className='w-[50%] h-[5vh] rounded-full px-10 py-5 text-black' value={user.number} type="number" name="number" placeholder='Enter your mobile no.' />
                                </div>
                                <div className='flex w-full items-center justify-between'>
                                    <h2 className='pl-5 text-2xl font-bold '>Your e-mail :-</h2>
                                    <input onChange={(e) => { handlechange(e) }} className='w-[50%] h-[5vh] rounded-full px-10 py-5 text-black' value={user.email} type="email" name="email" placeholder='Enter your email' />
                                </div>
                                <div className='flex w-full items-center justify-between'>
                                    <h2 className='pl-5 text-2xl font-bold '>Your Sername :-</h2>
                                    <input onChange={(e) => { handlechange(e) }} className='w-[50%] h-[5vh] rounded-full px-10 py-5 text-black' value={user.sername} type="text" name="sername" placeholder='Enter your sername' />
                                </div>
                                <div className='flex w-full items-center justify-between'>
                                    <h2 className='pl-5 text-2xl font-bold '>Your Address :- </h2>
                                    <input onChange={(e) => { handlechange(e) }} className='w-[50%] h-[5vh] rounded-full px-10 py-5 text-black' value={user.address} type="text" name="address" placeholder='Enter your address' />
                                </div>
                                <div className='flex w-full items-center justify-between'>
                                    <h2 className='pl-5 text-2xl font-bold '>Your Password :-</h2>
                                    <input onChange={(e) => { handlechange(e) }} className='w-[50%] h-[5vh] rounded-full px-10 py-5 text-black' value={user.password} type="password" name="password" placeholder='Enter your password' />
                                </div>
                    ...
                    <div className='Second w-[40vw] border border-gray-500 rounded-3xl p-5'>
